...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        printf("Hell");
        $employerModel->update($_REQUEST['fname'], $_REQUEST['lname'], $_REQUEST['cpf'], $_REQUEST['bdate'], $_REQUEST['address'], $_REQUEST['sex'], $_REQUEST['salary'], $_REQUEST['cnh'], $_REQUEST['dno']);
