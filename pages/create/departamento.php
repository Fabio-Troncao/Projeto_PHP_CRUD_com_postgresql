...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $mgr_start_date = $_REQUEST['mgr_start_date'];

    try {
        $departmentModel = new DepartmentModel($pdo);
        $departmentModel->insert($dname, $mgr_cpf, $mgr_start_date);
...
<div class="container">
    ...
    <div class="row py-5">
        ...
        <div class="col-6">
            <h4>Cadastrar novo Departamento</h4>
        </div>
        <div class="col"></div>
    </div>
    ...
    <form action="departamento.php" method="post">
        ...
        <input type="hidden" id="mgr_start_date" name="mgr_start_date" value="<?php echo date("Y-m-d") ?>">
